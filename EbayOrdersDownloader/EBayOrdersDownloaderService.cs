...
using EbayOrdersDownloader.DAL;
using System.Linq;

namespace EbayOrdersDownloader
{
    public partial class EBayOrdersDownloaderService : ServiceBase
    {
        ...
        public const string ServicePrettyName = "EBayOrdersDownloaderService";
        ...
        /// <summary>
        /// Sets the SKU code for Details Record
        /// </summary>
        /// <param name="detailRecordList">The list of DetailRecord</param>
