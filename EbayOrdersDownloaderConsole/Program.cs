...
namespace EbayOrdersDownloaderConsole
{
    class Program
    {
        ...
        private static void OnTimer()
        {
            ...
            try
            {
                orders = getOrdersApiCall.GetOrders(
                        new TimeFilter { TimeFrom = DateTime.Now.AddDays(DaysAgo), TimeTo = DateTime.Now },
            ...
            {
                Console.WriteLine("unable to retrieve orders from the server");
                return;
            }

            Console.WriteLine("total count of orders: " + orders.Count);
            int counter = 0;
            foreach (OrderType order in orders)
            {
                ...
                {
                    Console.WriteLine("en error occured at the step #: " + counter + "; message: " + e.Message);
                }
